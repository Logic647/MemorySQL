...
- 精确进度:见 `docs/DEVLOG.md` 最新一条(顶部);下一步:**验收自动更新(0.4.2 装机启动即应静默收 0.5.0)**、MCP 目录登记(PulseMCP/mcp.so/Smithery,材料在 docs/MCP_LISTING.md)、推广首发帖、winget bot 跟进(0.5.0 版 PR)
